            ...
            if (node.nodeType === 3) {
                ...
                for (var k = 0; k < textArray.length; k++) {
                    ...
                    for (var key in data) {
                        ...
                        if (((str.indexOf(key) === 0) || (str === key+"s")) && (str.length <= key.length + 1)) {
                            replacedArray[k] = "<span class='lolkeg' keyword='"+key+"'>" + textArray[k] + "</span>";
                            changed = true;
                            break;
                        }
                    }
                ...
                if (changed === true) {
                    pairs.push({element: element, old: node, new: "<span>"+replacedText+"</span>"});
                }
            }
        }
    }
...
//and when it receives the data saves it to the browser storage so i can
